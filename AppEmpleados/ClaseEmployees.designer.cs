...
namespace AppEmpleados
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="DenisMattoEmployees")]
	public partial class ClaseEmployeesDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertHistorialCambiosEmpleados(HistorialCambiosEmpleados instance);
    partial void UpdateHistorialCambiosEmpleados(HistorialCambiosEmpleados instance);
    partial void DeleteHistorialCambiosEmpleados(HistorialCambiosEmpleados instance);
    ...
    partial void Deletelocations(locations instance);
		...
		public ClaseEmployeesDataContext() : 
				base(global::AppEmpleados.Properties.Settings.Default.DenisMattoEmployeesConnectionString1, mappingSource)
		{
			OnCreated();
		}
		
		public ClaseEmployeesDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ClaseEmployeesDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ClaseEmployeesDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ClaseEmployeesDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<dependentsBis> dependentsBis
		{
			get
			{
				return this.GetTable<dependentsBis>();
			}
		}
		...
		public System.Data.Linq.Table<HistorialCambiosEmpleados> HistorialCambiosEmpleados
		{
			get
			{
				return this.GetTable<HistorialCambiosEmpleados>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.dependentsBis")]
	public partial class dependentsBis
	{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.HistorialCambiosEmpleados")]
	public partial class HistorialCambiosEmpleados : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _historial_id;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void Onhistorial_idChanging(int value);
    partial void Onhistorial_idChanged();
    ...
    partial void OnFechaModificacionChanged();
		...
		public HistorialCambiosEmpleados()
		{
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_historial_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int historial_id
		{
			get
			{
				return this._historial_id;
			}
			set
			{
				if ((this._historial_id != value))
				{
					this.Onhistorial_idChanging(value);
					this.SendPropertyChanging();
					this._historial_id = value;
					this.SendPropertyChanged("historial_id");
					this.Onhistorial_idChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_operacion", DbType="VarChar(10)")]
